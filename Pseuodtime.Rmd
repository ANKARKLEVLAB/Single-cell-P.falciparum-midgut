...
plot_cell_trajectory(cds, color_by = "cell_class")
...
legend(x="bottomright", 
       fill=plotcol[pst.ord], legend = clust)
...
bks <- seq(-2.1, 2.1, length.out = length(mypalette))
im3 <- im2[,1:3]
pheatmap(t(im3[1:60, ]), cluster_rows = F, cluster_cols = T, cellheight = 20, cellwidth = 7, breaks = myBreaks, fontsize_col = 7, fontsize_row = 10, angle_col = 90, clustering_method = "ward.D2", color = colorRampPalette(c("#440154", "#FDE725"))(100)) + coord_flip()
...
pheatmap(heatmap_matrix[sig_tf, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 6, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[ap_PF3D7_0516800, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 8, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[ap_PF3D7_0420300, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 8, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[ap_PF3D7_1139300, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 8, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[ap_PF3D7_1239200, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 4, silent = F, cellwidth = 0.2, cellheight = 5, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[ap_PF3D7_0802100, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize = 5, silent = F, cellwidth = 0.2, cellheight = 8, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")

png(filename = "~/Desktop/Zygote/figs/Pseudotime/new_figs/P_heatmaps/ApiAP2_target/Apiap2_TF_25cells.png", width = 40, height= 25, unit = "cm", res= 300)
print(p1)
dev.off()
```
...
pheatmap(heatmap_matrix[egress_genes, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize_row =7, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[meosis_genes, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize_row = 8, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row")
...
pheatmap(heatmap_matrix[cyto, ], color = plotcol[pst.ord], cluster_cols = F, breaks = bks, cluster_rows = T, show_colnames = F, clustering_method = "complete", fontsize_row = 7, silent = F, cellwidth = 0.2, cellheight = 10, clustering_distance_rows = "euclidean", show_rownames = T, scale = "row", legend_labels = TRUE)
...
for other plots 
```{r}
png(filename = "~/Desktop/Zygote/figs/Pseudotime/new_figs/zygote/ARP_UMAP.png", width = 15, height= 10, unit = "cm", res= 300)
print(p6)
dev.off()
```
